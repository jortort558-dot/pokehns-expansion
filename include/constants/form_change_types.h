...
enum FormChanges
{
    ...
    // If it's on the player's side, it also requires ITEM_MEGA_RING in the user's bag and for the player to trigger it by pressing SELECT before selecting a move.
    // param1: item to hold.
