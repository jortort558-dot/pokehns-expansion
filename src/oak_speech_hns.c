...
{
    static const u8 sText_Disclaimer[] = _("¿Qué desafío buscas?\p{COLOR RED}Los siguientes ajustes se pueden cambiar\nen el PC tras iniciar la partida.\lSin embargo, tras empezar el juego,\llas opciones de nuzlocke, randomlocke,\ldificultad y desafíos solo podrán\lhacerse más fáciles, no más difíciles.");
    NewGameHnsSpeech_ClearWindow(0);
