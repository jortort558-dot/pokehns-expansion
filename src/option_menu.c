...
static const u8 sText_Desc_TextSpeed[] = _("Elige una de las cuatro velocidades\nde texto.");
...
static const u8 *const sDesc_BattleScene[] = {
    COMPOUND_STRING("Muestra animaciones de POKéMON\ny ataques."),
    COMPOUND_STRING("Omite animaciones de POKéMON\ny ataques."),
};
static const u8 *const sDesc_BattleStyle[] = {
    COMPOUND_STRING("Opción de cambiar POKéMON tras\nderrotar a un rival."),
    COMPOUND_STRING("Sin cambio libre al debilitar a un\nPOKéMON enemigo."),
};
static const u8 *const sDesc_ButtonMode[] = {
    COMPOUND_STRING("Todos los botones funcionan normal."),
    COMPOUND_STRING("Los botones L y R actúan como\nizquierda y derecha."),
    COMPOUND_STRING("El botón L actúa como A para jugar\ncon una mano."),
};
static const u8 *const sDesc_Follower[] = {
    COMPOUND_STRING("Tu primer POKéMON del equipo te\nsigue."),
    COMPOUND_STRING("Caminar solo."),
};
static const u8 *const sDesc_LargeFollower[] = {
    COMPOUND_STRING("Permite seguidores grandes.\nPuede causar fallos gráficos."),
    COMPOUND_STRING("Desactiva seguidores grandes.\nRecomendado."),
};
static const u8 *const sDesc_Autorun[] = {
    COMPOUND_STRING("Correr sin pulsar B."),
    COMPOUND_STRING("Mantener B pulsado para correr."),
};
static const u8 *const sDesc_AutorunSurf[] = {
    COMPOUND_STRING("Surf rápido sin pulsar B."),
    COMPOUND_STRING("Mantener B para surf más rápido."),
};
static const u8 *const sDesc_Fishing[] = {
    COMPOUND_STRING("Recoge la caña automáticamente."),
    COMPOUND_STRING("Recoge manualmente al pescar.\n¡Como siempre!"),
};
static const u8 *const sDesc_FasterJoy[] = {
    COMPOUND_STRING("ENFERMERA JOY cura más rápido."),
    COMPOUND_STRING("ENFERMERA JOY cura con la animación\nhabitual."),
};
static const u8 *const sDesc_UnitType[] = {
    COMPOUND_STRING("Muestra peso y tamaño en kilos\ny metros."),
    COMPOUND_STRING("Muestra peso y tamaño en libras\ne pulgadas."),
};
static const u8 *const sDesc_MatchCall[] = {
    COMPOUND_STRING("Los entrenadores podrán llamarte\npara revanchas."),
    COMPOUND_STRING("No recibirás llamadas.\nHabrá eventos especiales."),
};
static const u8 *const sDesc_FrameType[] = {
    COMPOUND_STRING("Elige el marco de las ventanas."),
};
static const u8 *const sDesc_FastIntro[] = {
    COMPOUND_STRING("Omite la animación de entrada a\ncombate."),
    COMPOUND_STRING("Carga combates a velocidad normal."),
};
static const u8 *const sDesc_FastBattles[] = {
    COMPOUND_STRING("Omite pausas en combates para que\nsean más rápidos."),
    COMPOUND_STRING("Pausas manuales. Pulsa A o B para\nsaltar pausas."),
};
static const u8 *const sDesc_NewBackgrounds[] = {
    COMPOUND_STRING("Fondos originales de combate."),
    COMPOUND_STRING("Fondos de terreno modernos de HnS."),
};
static const u8 *const sDesc_NewBattleUI[] = {
    COMPOUND_STRING("Interfaz de combate original GEN 3."),
    COMPOUND_STRING("Interfaz moderna de combate GEN 4."),
};
static const u8 *const sDesc_BallPrompt[] = {
    COMPOUND_STRING("Pulsa {R_BUTTON} en combate para usar BALLS.\nMantén {L_BUTTON}/{R_BUTTON} para cambiar."),
    COMPOUND_STRING("Desactiva el acceso rápido a\n{PKMN}BALLS."),
};
static const u8 *const sDesc_RunType[] = {
    COMPOUND_STRING("Sin huida rápida en combates."),
    COMPOUND_STRING("Mantén {L_BUTTON}+{R_BUTTON}, luego {A_BUTTON} para\nhuir antes de empezar."),
    COMPOUND_STRING("Pulsa {B_BUTTON} para mover el cursor a\nHUIR tras empezar."),
    COMPOUND_STRING("Pulsa {B_BUTTON} para huir antes de empezar."),
};
static const u8 *const sDesc_LRRun[] = {
    COMPOUND_STRING("Muestra aviso para huir de combates."),
    COMPOUND_STRING("Desactiva el aviso de huida.\nLa combinación funciona."),
};
static const u8 *const sDesc_Sound[] = {
    COMPOUND_STRING("El sonido es igual en ambos altavoces."),
    COMPOUND_STRING("Canales izquierdo y derecho por\nseparado. Ideal con auriculares."),
};
static const u8 *const sDesc_Music[] = {
    COMPOUND_STRING("Activa la música.\nCambia de mapa para aplicar."),
...
static const struct OptionMenuItem sTabItems_Main[] = {
    [ITEM_MAIN_TEXTSPEED] = {
        .name         = COMPOUND_STRING("VELOC. TEXTO"),
    ...
    [ITEM_MAIN_AUTORUN_SURF] = {
        .name         = COMPOUND_STRING("SURF RÁP. AUTO."),
    ...
    [ITEM_MAIN_MATCHCALL] = {
        .name         = COMPOUND_STRING("LLAMADAS Y DEB."),
        .descriptions = sDesc_MatchCall,
        .numChoices   = 2,
        .choiceNames  = sChoices_OnOff,
    },
    [ITEM_MAIN_FRAMETYPE] = {
        .name         = COMPOUND_STRING("MARCO"),
...
static const struct OptionMenuItem sTabItems_Battle[] = {
    [ITEM_BATTLE_FAST_INTRO] = {
        .name         = COMPOUND_STRING("INTRO RÁPIDA"),
        .descriptions = sDesc_FastIntro,
        .numChoices   = 2,
        .choiceNames  = sChoices_OnOff,
    },
    [ITEM_BATTLE_FAST_BATTLES] = {
        .name         = COMPOUND_STRING("COMBATE RÁPIDO"),
        .descriptions = sDesc_FastBattles,
        .numChoices   = 2,
        .choiceNames  = sChoices_OnOff,
    },
    [ITEM_BATTLE_NEW_BACKGROUNDS] = {
        .name         = COMPOUND_STRING("TERRENO COMBATE"),
    ...
    [ITEM_BATTLE_BALL_PROMPT] = {
        .name         = COMPOUND_STRING("ACCESO A BALLS"),
    ...
    [ITEM_BATTLE_LR_RUN] = {
        .name         = COMPOUND_STRING("AVISO DE HUIDA"),
...
static const struct TabDef sTabs[TAB_COUNT] = {
    ...
    [TAB_BATTLE] = { COMPOUND_STRING("COMBATE"), sTabItems_Battle, ITEM_BATTLE_COUNT },
