...
static const u8 gText_NumberRegistered[] = _("N.º registrados");
static const u8 gText_NumberOfBattles[] = _("N.º de combates");
static const u8 gText_TrainerCloseBy[] = _("Ese ENTRENADOR está cerca.\n¡Habla con él en persona!");
...
static const u8 *const sMatchCallOptionTexts[MATCH_CALL_OPTION_COUNT] =
{
    ...
    [MATCH_CALL_OPTION_CHECK]  = COMPOUND_STRING("DATOS"),
