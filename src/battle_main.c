...
const struct TrainerClass gTrainerClasses[TRAINER_CLASS_COUNT] =
{
    ...
    [TRAINER_CLASS_COOLTRAINER] = { _("ENTR. GUAY"), 12, BALL_ULTRA },
    [TRAINER_CLASS_BIRD_KEEPER] = { _("ORNITÓLOGO"), 8 },
    [TRAINER_CLASS_COLLECTOR] = { _("COLECCION."), 15, BALL_PREMIER },
    [TRAINER_CLASS_SWIMMER_M] = { _("NADADOR"), 2, BALL_DIVE },
    [TRAINER_CLASS_TEAM_MAGMA] = { _("TEAM MAGMA") },
    [TRAINER_CLASS_EXPERT] = { _("EXPERTO"), 10 },
    ...
    [TRAINER_CLASS_HEX_MANIAC] = { _("BRUJA"), 6 },
    ...
    [TRAINER_CLASS_PALACE_MAVEN] = { _("MAESTRO") },
    [TRAINER_CLASS_ARENA_TYCOON] = { _("MAGNATE") },
    [TRAINER_CLASS_FACTORY_HEAD] = { _("JEFE FÁBRICA") },
    [TRAINER_CLASS_PIKE_QUEEN] = { _("REINA") },
    [TRAINER_CLASS_PYRAMID_KING] = { _("REY PIRÁMIDE") },
    [TRAINER_CLASS_RS_PROTAG] = { _("ENTRENADOR") },

    [TRAINER_CLASS_YOUNGSTER_FRLG] =       { _("JOVEN"), 4 },
    [TRAINER_CLASS_BUG_CATCHER_FRLG] =     { _("CAZABICHOS"), 3 },
    [TRAINER_CLASS_LASS_FRLG] =            { _("CHICA"), 4 },
    [TRAINER_CLASS_SAILOR_FRLG] =          { _("MARINERO"), 8 },
    [TRAINER_CLASS_CAMPER_FRLG] =          { _("CAMPISTA"), 5 },
    [TRAINER_CLASS_PICNICKER_FRLG] =       { _("DOMINGUERA"), 5 },
    [TRAINER_CLASS_POKEMANIAC_FRLG] =      { _("POKéMANÍACO"), 12 },
    [TRAINER_CLASS_SUPER_NERD_FRLG] =      { _("SUPERNECIO"), 6 },
    [TRAINER_CLASS_HIKER_FRLG] =           { _("MONTAÑERO"), 9 },
    [TRAINER_CLASS_BIKER_FRLG] =           { _("MOTORISTA"), 5 },
    [TRAINER_CLASS_BURGLAR_FRLG] =         { _("LADRÓN"), 22 },
    ...
    [TRAINER_CLASS_SWIMMER_M_FRLG] =       { _("NADADOR"), 1 },
    [TRAINER_CLASS_CUE_BALL_FRLG] =        { _("CUE BALL"), 6 },
    [TRAINER_CLASS_GAMER_FRLG] =           { _("GAMER"), 18 },
    [TRAINER_CLASS_BEAUTY_FRLG] =          { _("BELLA"), 18 },
    [TRAINER_CLASS_SWIMMER_F_FRLG] =       { _("NADADORA"), 1, BALL_DIVE },
    [TRAINER_CLASS_PSYCHIC_FRLG] =         { _("MÉDIUM"), 5 },
    [TRAINER_CLASS_ROCKER_FRLG] =          { _("ROCKER"), 6 },
    [TRAINER_CLASS_JUGGLER_FRLG] =         { _("MALABARISTA"), 10 },
    [TRAINER_CLASS_TAMER_FRLG] =           { _("TAMER"), 10 },
    [TRAINER_CLASS_BIRD_KEEPER_FRLG] =     { _("ORNITÓLOGO"), 6 },
    ...
    [TRAINER_CLASS_LEADER_FRLG] =          { _("LÍDER"), 25 },
    [TRAINER_CLASS_TEAM_ROCKET_FRLG] =     { _("TEAM ROCKET"), 8 },
    [TRAINER_CLASS_COOLTRAINER_FRLG] =     { _("ENTR. GUAY"), 9, BALL_ULTRA },
    [TRAINER_CLASS_ELITE_FOUR_FRLG] =      { _("ALTO MANDO"), 25, BALL_ULTRA },
    [TRAINER_CLASS_GENTLEMAN_FRLG] =       { _("CABALLERO"), 18, BALL_LUXURY },
    [TRAINER_CLASS_RIVAL_LATE_FRLG] =      { _("RIVAL"), 9 },
    [TRAINER_CLASS_CHAMPION_FRLG] =        { _("CAMPEÓN"), 25 },
    [TRAINER_CLASS_CHANNELER_FRLG] =       { _("CHANNELER"), 8 },
    [TRAINER_CLASS_TWINS_FRLG] =           { _("GEMELAS"), 3 },
    [TRAINER_CLASS_COOL_COUPLE_FRLG] =     { _("COOL COUPLE"), 6 },
    [TRAINER_CLASS_YOUNG_COUPLE_FRLG] =    { _("PAREJA JOVEN"), 7 },
    ...
    [TRAINER_CLASS_PLAYER_FRLG] =          { _("ENTRENADOR"), 1 },
    ...
    // HnS Trainer Classes
    [TRAINER_CLASS_ARENA_TYCOON_HNS] =     { _("MAGNATE") },
    [TRAINER_CLASS_BATTLE_GIRL_HNS] =      { _("LUCHADORA"), 6 },
    [TRAINER_CLASS_BEAUTY_HNS] =           { _("BELLA"), 20 },
    [TRAINER_CLASS_BIKER_HNS] =            { _("MOTORISTA") },
    [TRAINER_CLASS_BIRD_KEEPER_HNS] =      { _("ORNITÓLOGO"), 8 },
    [TRAINER_CLASS_BLACK_BELT_HNS] =       { _("KARATEKA"), 8, BALL_ULTRA },
    [TRAINER_CLASS_BUG_CATCHER_HNS] =      { _("CAZABICHOS"), 4 },
    [TRAINER_CLASS_BURGLAR_HNS] =          { _("LADRÓN") },
    [TRAINER_CLASS_CAMPER_HNS] =           { _("CAMPISTA"), 4 },
    [TRAINER_CLASS_CHAMPION_HNS] =         { _("CAMPEÓN"), 50, BALL_ULTRA },
    [TRAINER_CLASS_COLLECTOR_HNS] =        { _("COLECCION."), 15, BALL_PREMIER },
    [TRAINER_CLASS_COOLTRAINER_HNS] =      { _("ENTR. GUAY"), 12, BALL_ULTRA },
    [TRAINER_CLASS_DOME_ACE_HNS] =         { _("ASTRO CÚPULA") },
    [TRAINER_CLASS_DRAGON_TAMER_HNS] =     { _("DOMADRAGÓN"), 12 },
    [TRAINER_CLASS_ELITE_FOUR_HNS] =       { _("ALTO MANDO"), 25, BALL_ULTRA },
    [TRAINER_CLASS_EXPERT_HNS] =           { _("EXPERTO"), 10 },
    [TRAINER_CLASS_FACTORY_HEAD_HNS] =     { _("JEFE FÁBRICA") },
    [TRAINER_CLASS_FIREBREATHER_HNS] =     { _("COMEFUEGOS") },
    [TRAINER_CLASS_FISHERMAN_HNS] =        { _("PESCADOR"), 10, B_TRAINER_CLASS_POKE_BALLS >= GEN_8 ? BALL_DIVE : BALL_LURE },
    [TRAINER_CLASS_GENTLEMAN_HNS] =        { _("CABALLERO"), 20, BALL_LUXURY },
    [TRAINER_CLASS_GUITARIST_HNS] =        { _("GUITARRISTA"), 8 },
    [TRAINER_CLASS_HEX_MANIAC_HNS] =       { _("BRUJA"), 6 },
    [TRAINER_CLASS_HIKER_HNS] =            { _("MONTAÑERO"), 10 },
    [TRAINER_CLASS_JUGGLER_HNS] =          { _("MALABARISTA") },
    [TRAINER_CLASS_KIMONO_GIRL_HNS] =      { _("CHICA KIMONO") },
    [TRAINER_CLASS_LASS_HNS] =             { _("CHICA"), 4 },
    [TRAINER_CLASS_LEADER_HNS] =           { _("LÍDER"), 25 },
    [TRAINER_CLASS_LEADER_KANTO_HNS] =     { _("LÍDER"), 25 },
    [TRAINER_CLASS_MYSTERY_MAN_HNS] =      { _("MISTERIO") },
    [TRAINER_CLASS_OFFICER_HNS] =          { _("POLICÍA") },
    [TRAINER_CLASS_PALACE_MAVEN_HNS] =     { _("MAESTRO") },
    [TRAINER_CLASS_PARASOL_LADY_HNS] =     { _("DAMISELA"), 10 },
    [TRAINER_CLASS_PICNICKER_HNS] =        { _("DOMINGUERA"), 4 },
    [TRAINER_CLASS_PIKE_QUEEN_HNS] =       { _("REINA") },
    [TRAINER_CLASS_PKMN_TRAINER_1_HNS] =   { _("ENTRENADOR") },
    [TRAINER_CLASS_POKEFAN_HNS] =          { _("POKéFAN"), 20 },
    [TRAINER_CLASS_POKEMANIAC_HNS] =       { _("POKéMANÍACO"), 15 },
    [TRAINER_CLASS_PSYCHIC_HNS] =          { _("MÉDIUM"), 6 },
    [TRAINER_CLASS_PSYCHIC_M_HNS] =        { _("MÉDIUM"), 6 },
    [TRAINER_CLASS_RIVAL_HNS] =            { _("ENTRENADOR"), 15 },
    [TRAINER_CLASS_ROCKET_ADMIN_HNS] =     { _("ADMIN ROCKET") },
    [TRAINER_CLASS_SAGE_HNS] =             { _("SABIO") },
    [TRAINER_CLASS_SAILOR_HNS] =           { _("MARINERO"), 8 },
    [TRAINER_CLASS_SALON_MAIDEN_HNS] =     { _("DAMA TORRE"), 5, BALL_ULTRA },
    [TRAINER_CLASS_SCHOOL_KID_HNS] =       { _("ESCOLAR") },
    [TRAINER_CLASS_SKIER_HNS] =            { _("ESQUIADOR"), 10 },
    [TRAINER_CLASS_SUPER_NERD_HNS] =       { _("SUPERNECIO"), 8 },
    [TRAINER_CLASS_SWIMMER_F_HNS] =        { _("NADADORA"), 2, BALL_DIVE },
    [TRAINER_CLASS_SWIMMER_M_HNS] =        { _("NADADOR"), 2, BALL_DIVE },
    [TRAINER_CLASS_TEAM_ROCKET_HNS] =      { _("ROCKET") },
    [TRAINER_CLASS_TWINS_HNS] =            { _("GEMELAS"), 3 },
    [TRAINER_CLASS_YOUNG_COUPLE_HNS] =     { _("PAREJA JOVEN"), 8 },
    [TRAINER_CLASS_YOUNGSTER_HNS] =        { _("JOVEN"), 4 },
    [TRAINER_CLASS_PROFESSOR_HNS] =        { _("PROF. {PKMN}"), 25, BALL_FRIEND},
    [TRAINER_CLASS_DEVELOPER_HNS] =        { _("DESARROLL."), 50, BALL_MASTER},
    [TRAINER_CLASS_PYRAMID_KING_HNS] =     { _("REY PIRÁMIDE") },
};
