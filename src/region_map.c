...
static const struct RegionMapLocation sRegionMapEntries_Johto[] = {
    ...
    [MAPSEC_OLIVINE_CITY]      = { 3,  6,  1, 1, COMPOUND_STRING("CIUDAD OLIVO") },
    [MAPSEC_CIANWOOD_CITY]     = { 1,  9,  1, 1, COMPOUND_STRING("CIUDAD ORQUÍDEA") },
    [MAPSEC_SAFARI_ZONE_GATE]  = { 0,  7,  1, 1, COMPOUND_STRING("SAFARI ZONE GATE") },
    [MAPSEC_MAHOGANY_TOWN]     = { 9,  3,  1, 1, COMPOUND_STRING("PUEBLO CAOBA") },
    [MAPSEC_BLACKTHORN_CITY]   = { 12, 3,  1, 1, COMPOUND_STRING("CIUDAD ENDRINO") },
    [MAPSEC_CHERRYGROVE_CITY]  = { 9,  11, 1, 1, COMPOUND_STRING("CIUDAD CEREZO") },
    [MAPSEC_NEW_BARK_TOWN]     = { 13, 11, 1, 1, COMPOUND_STRING("PUEBLO PRIMAVERA") },
    [MAPSEC_INDIGO_PLATEAU]    = { 16, 2,  1, 2, COMPOUND_STRING("MESETA AÑIL") },
    [MAPSEC_BATTLE_FRONTIER]   = { 12, 14, 1, 1, COMPOUND_STRING("FRENTE BATALLA") },
    [MAPSEC_ROUTE_26]          = { 16, 8,  1, 4, COMPOUND_STRING("RUTA 26") },
    [MAPSEC_ROUTE_27]          = { 14, 11, 3, 1, COMPOUND_STRING("RUTA 27") },
    [MAPSEC_ROUTE_28]          = { 15, 7,  1, 1, COMPOUND_STRING("RUTA 28") },
    [MAPSEC_ROUTE_29]          = { 10, 11, 3, 1, COMPOUND_STRING("RUTA 29") },
    [MAPSEC_ROUTE_30]          = { 9,  6,  1, 5, COMPOUND_STRING("RUTA 30") },
    [MAPSEC_ROUTE_31]          = { 8,  5,  2, 1, COMPOUND_STRING("RUTA 31") },
    [MAPSEC_ROUTE_32]          = { 7,  6,  1, 5, COMPOUND_STRING("RUTA 32") },
    [MAPSEC_ROUTE_33]          = { 7,  12, 1, 1, COMPOUND_STRING("RUTA 33") },
    [MAPSEC_ROUTE_34]          = { 5,  9,  1, 2, COMPOUND_STRING("RUTA 34") },
    [MAPSEC_ROUTE_35]          = { 5,  6,  1, 1, COMPOUND_STRING("RUTA 35") },
    [MAPSEC_ROUTE_36]          = { 6,  5,  1, 1, COMPOUND_STRING("RUTA 36") },
    [MAPSEC_ROUTE_37]          = { 6,  4,  1, 1, COMPOUND_STRING("RUTA 37") },
    [MAPSEC_ROUTE_38]          = { 4,  3,  2, 1, COMPOUND_STRING("RUTA 38") },
    [MAPSEC_ROUTE_39]          = { 3,  3,  1, 3, COMPOUND_STRING("RUTA 39") },
    [MAPSEC_ROUTE_40]          = { 2,  6,  1, 3, COMPOUND_STRING("RUTA 40") },
    [MAPSEC_ROUTE_41]          = { 2,  9,  1, 1, COMPOUND_STRING("RUTA 41") },
    [MAPSEC_ROUTE_42]          = { 7,  3,  2, 1, COMPOUND_STRING("RUTA 42") },
    [MAPSEC_ROUTE_43]          = { 9,  2,  1, 1, COMPOUND_STRING("RUTA 43") },
    [MAPSEC_ROUTE_44]          = { 10, 3,  2, 1, COMPOUND_STRING("RUTA 44") },
    [MAPSEC_ROUTE_45]          = { 12, 4,  1, 5, COMPOUND_STRING("RUTA 45") },
    [MAPSEC_ROUTE_46]          = { 11, 8,  1, 3, COMPOUND_STRING("RUTA 46") },
    [MAPSEC_ROUTE_47]          = { 0,  9,  1, 1, COMPOUND_STRING("RUTA 47") },
    [MAPSEC_ROUTE_48]          = { 0,  8,  1, 1, COMPOUND_STRING("RUTA 48") },
    [MAPSEC_SAFARI_ZONE]       = { 0,  6,  1, 1, COMPOUND_STRING("ZONA SAFARI") },
    [MAPSEC_VICTORY_ROAD_HNS]  = { 16, 4,  1, 4, COMPOUND_STRING("CALLE VICTORIA") },
