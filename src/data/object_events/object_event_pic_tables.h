...
static const struct SpriteFrameImage sPicTable_Knekro_hns[] = {
    overworld_frame(gObjectEventPic_Knekro_hns, 2, 4, 0),
    overworld_frame(gObjectEventPic_Knekro_hns, 2, 4, 1),
    overworld_frame(gObjectEventPic_Knekro_hns, 2, 4, 2),
    overworld_frame(gObjectEventPic_Knekro_hns, 2, 4, 3),
    overworld_frame(gObjectEventPic_Knekro_hns, 2, 4, 4),
    overworld_frame(gObjectEventPic_Knekro_hns, 2, 4, 5),
    overworld_frame(gObjectEventPic_Knekro_hns, 2, 4, 6),
    overworld_frame(gObjectEventPic_Knekro_hns, 2, 4, 7),
    overworld_frame(gObjectEventPic_Knekro_hns, 2, 4, 8),
};
