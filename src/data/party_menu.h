...
{
    [MENU_SUMMARY]         = {COMPOUND_STRING("DATOS"),         CursorCb_Summary},
    ...
    [MENU_SHIFT]           = {COMPOUND_STRING("CAMBIO"),           CursorCb_SendMon},
    ...
    [MENU_LEVEL_UP_MOVES]  = {COMPOUND_STRING("POR NIVEL"),     CursorCb_ChangeLevelUpMoves},
    [MENU_EGG_MOVES]       = {COMPOUND_STRING("MOV. HUEVO"),       CursorCb_ChangeEggMoves},
    [MENU_TM_MOVES]        = {COMPOUND_STRING("MOV. MT"),        CursorCb_ChangeTMMoves},
    [MENU_TUTOR_MOVES]     = {COMPOUND_STRING("POR TUTOR"),     CursorCb_ChangeTutorMoves},
    [MENU_SUB_MOVES]       = {COMPOUND_STRING("APRENDER"),     CursorCb_LearnMovesSubMenu},
    ...
    [MENU_PKMN_FOLLOWER]   = {COMPOUND_STRING("{PKMN} SEGUIDOR"), CursorCb_PkmnFollower},
};
