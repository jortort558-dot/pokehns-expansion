...
static const u8 gText_WirelessNotConnected[] = _("El adaptador inalámbrico no está\nconectado.");
static const u8 gText_MysteryGiftCantUse[] = _("No se puede usar REGALO MISTERIOSO\ncon el adaptador inalámbrico.");
static const u8 gText_MysteryEventsCantUse[] = _("No se puede usar EVENTO MISTERIOSO\ncon el adaptador inalámbrico.");
