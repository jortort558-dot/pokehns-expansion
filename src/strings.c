...
const u8 gText_BagFullCouldNotRemoveItem[] = _("La BOLSA está llena. No se pudo\nretirar el objeto del POKéMON.{PAUSE_UNTIL_PRESS}");
...
const u8 gText_BagIsFull[] = _("La BOLSA está llena.{PAUSE_UNTIL_PRESS}");
const u8 gText_MailToBagMessageErased[] = _("La CARTA se devolvió a la BOLSA\ncon su mensaje borrado.{PAUSE_UNTIL_PRESS}");
