...
const u8 gText_PkmnShroudedInMist[] = _("¡Una niebla cubrió al equipo {B_ATK_TEAM1}!");
const u8 gText_PkmnGettingPumped[] = _("¡{B_DEF_NAME_WITH_PREFIX} se está motivando!");
...
static const u8 sText_PlayerDefeatedLinkTrainer[] = _("¡Has derrotado a {B_LINK_OPPONENT1_NAME}!");
static const u8 sText_TwoLinkTrainersDefeated[] = _("¡Has derrotado a {B_LINK_OPPONENT1_NAME} y {B_LINK_OPPONENT2_NAME}!");
...
static const u8 sText_PlayerBattledToDrawLinkTrainer[] = _("¡Has empatado contra {B_LINK_OPPONENT1_NAME}!");
static const u8 sText_PlayerBattledToDrawVsTwo[] = _("¡Has empatado contra {B_LINK_OPPONENT1_NAME} y {B_LINK_OPPONENT2_NAME}!");
...
static const u8 sText_PlayerDefeatedLinkTrainerTrainer1[] = _("¡Has derrotado a {B_TRAINER1_NAME_WITH_CLASS}!\p");
...
static const u8 sText_WildPkmnAppearedLR[] = _("¡Apareció {B_OPPONENT_MON1_NAME} salvaje!\n¿Huir? {L_BUTTON}+{R_BUTTON}+{A_BUTTON}\p");
static const u8 sText_WildPkmnAppearedB[] = _("¡Apareció {B_OPPONENT_MON1_NAME} salvaje!\n¿Huir? Pulsa {B_BUTTON}.\p");
static const u8 sText_LegendaryPkmnAppeared[] = _("¡Te has encontrado un {B_OPPONENT_MON1_NAME} salvaje!\p");
static const u8 sText_WildPkmnAppearedPause[] = _("¡Te has encontrado un {B_OPPONENT_MON1_NAME} salvaje!{PAUSE 127}");
static const u8 sText_TwoWildPkmnAppeared[] = _("¡Han aparecido {B_OPPONENT_MON1_NAME} y {B_OPPONENT_MON2_NAME} salvajes!\p");
static const u8 sText_GhostAppearedCantId[] = _("¡Ha aparecido el FANTASMA!\p¡Maldición!\n¡No se puede identificar!\p");
...
static const u8 sText_Trainer1SentOutPkmn[] = _("¡{B_TRAINER1_NAME_WITH_CLASS} envió a\n{B_OPPONENT_MON1_NAME}!");
static const u8 sText_Trainer1SentOutTwoPkmn[] = _("¡{B_TRAINER1_NAME_WITH_CLASS} envió a\n{B_OPPONENT_MON1_NAME} y a {B_OPPONENT_MON2_NAME}!");
static const u8 sText_Trainer1SentOutPkmn2[] = _("¡{B_TRAINER1_NAME_WITH_CLASS} envió a\n{B_BUFF1}!");
static const u8 sText_LinkTrainerSentOutPkmn[] = _("¡{B_LINK_OPPONENT1_NAME} envió a\n{B_OPPONENT_MON1_NAME}!");
static const u8 sText_LinkTrainer2SentOutPkmn2[] = _("¡{B_LINK_OPPONENT2_NAME} envió a\n{B_OPPONENT_MON2_NAME}!");
...
static const u8 sText_GoForItPkmn[] = _("¡Adelante, {B_BUFF1}!");
static const u8 sText_JustALittleMorePkmn[] = _("¡Un poco más! ¡Resiste, {B_BUFF1}!");
static const u8 sText_YourFoesWeakGetEmPkmn[] = _("¡Tu rival está débil!\n¡A por él, {B_BUFF1}!");
static const u8 sText_LinkPartnerSentOutPkmn1GoPkmn[] = _("¡{B_LINK_PARTNER_NAME} envió a {B_LINK_PLAYER_MON1_NAME}!\n¡Adelante, {B_LINK_PLAYER_MON2_NAME}!");
static const u8 sText_LinkPartnerSentOutPkmn2GoPkmn[] = _("¡{B_LINK_PARTNER_NAME} envió a {B_LINK_PLAYER_MON2_NAME}!\n¡Adelante, {B_LINK_PLAYER_MON1_NAME}!");
static const u8 sText_LinkPartnerSentOutPkmn1[] = _("¡{B_LINK_PARTNER_NAME} envió a {B_LINK_PLAYER_MON1_NAME}!");
static const u8 sText_LinkPartnerSentOutPkmn2[] = _("¡{B_LINK_PARTNER_NAME} envió a {B_LINK_PLAYER_MON2_NAME}!");
...
static const u8 sText_PkmnSwitchOut[] = _("¡{B_BUFF1}, cambio! ¡Vuelve!");
static const u8 sText_PkmnThatsEnough[] = _("¡Suficiente, {B_BUFF1}!\n¡Vuelve!");
static const u8 sText_PkmnComeBack[] = _("¡Vuelve, {B_BUFF1}!");
static const u8 sText_PkmnOkComeBack[] = _("¡Bien hecho, {B_BUFF1}!\n¡Vuelve!");
static const u8 sText_PkmnGoodComeBack[] = _("¡Buen trabajo, {B_BUFF1}!\n¡Vuelve!");
static const u8 sText_Trainer1WithdrewPkmn[] = _("¡{B_TRAINER1_NAME_WITH_CLASS} retiró a\n{B_BUFF1}!");
static const u8 sText_Trainer2WithdrewPkmn[] = _("¡{B_TRAINER2_NAME_WITH_CLASS} retiró a\n{B_BUFF1}!");
static const u8 sText_LinkTrainer1WithdrewPkmn[] = _("¡{B_LINK_OPPONENT1_NAME} retiró a\n{B_BUFF1}!");
static const u8 sText_LinkTrainer2WithdrewPkmn[] = _("¡{B_LINK_OPPONENT2_NAME} retiró a\n{B_BUFF1}!");
...
static const u8 sText_SpDefense[] = _("DF. ESP");
...
{
    [FLAVOR_SPICY]  = COMPOUND_STRING("¡estaba muy picante!"),
    [FLAVOR_DRY]    = COMPOUND_STRING("¡estaba muy seco!"),
    [FLAVOR_SWEET]  = COMPOUND_STRING("¡estaba muy dulce!"),
    [FLAVOR_BITTER] = COMPOUND_STRING("¡estaba muy amargo!"),
    [FLAVOR_SOUR]   = COMPOUND_STRING("¡estaba muy ácido!"),
};
...
static const u8 sText_TwoInGameTrainersDefeated[] = _("¡Has derrotado a {B_TRAINER1_NAME_WITH_CLASS} y {B_TRAINER2_NAME_WITH_CLASS}!\p");

// New battle strings.
const u8 gText_drastically[] = _("drásticamente ");
const u8 gText_severely[] = _("severamente ");
static const u8 sText_TerrainReturnedToNormal[] = _("¡El campo volvió a la normalidad!"); // Unused
...
const u8 *const gBattleStringsTable[STRINGID_COUNT] =
{
    ...
    [STRINGID_TRYTOLEARNMOVE3]                      = COMPOUND_STRING("¿Quieres olvidar un movimiento para aprender {B_BUFF2}?"),
    [STRINGID_PKMNFORGOTMOVE]                       = COMPOUND_STRING("{B_BUFF1} olvidó {B_BUFF2}…\p"),
    [STRINGID_STOPLEARNINGMOVE]                     = COMPOUND_STRING("{PAUSE 32}¿Dejas de intentar que {B_BUFF1}\naprenda {B_BUFF2}?"),
    ...
    [STRINGID_ATTACKMISSED]                         = COMPOUND_STRING("¡El ataque de {B_ATK_NAME_WITH_PREFIX}\nfalló!"),
    ...
    [STRINGID_PLAYERWHITEOUT2_WILD]                 = COMPOUND_STRING("¡Te entró el pánico y perdiste ¥{B_BUFF1}…"),
    [STRINGID_PLAYERWHITEOUT2_TRAINER]              = COMPOUND_STRING("¡Le diste ¥{B_BUFF1} al vencedor…"),
    [STRINGID_PLAYERWHITEOUT3]                      = COMPOUND_STRING("¡La derrota te sobrepasó por completo!"),
    [STRINGID_PREVENTSESCAPE]                       = COMPOUND_STRING("{B_SCR_NAME_WITH_PREFIX} impide escapar con {B_SCR_ABILITY}!\p"),
    [STRINGID_HITXTIMES]                            = COMPOUND_STRING("¡El Pokémon recibió {B_BUFF1} golpe(s)!"), //SV has dynamic plural here
    ...
    [STRINGID_PKMNHURTBYPOISON]                     = COMPOUND_STRING("¡El veneno resta salud a\n{B_ATK_NAME_WITH_PREFIX}!"),
    ...
    [STRINGID_PKMNBURNEDBY]                         = COMPOUND_STRING("¡{B_BUFF1} de {B_SCR_NAME_WITH_PREFIX} quemó a {B_EFF_NAME_WITH_PREFIX}!"), //not in gen 5+, ability popup
    [STRINGID_PKMNHURTBYBURN]                       = COMPOUND_STRING("¡Las quemaduras restan salud a\n{B_ATK_NAME_WITH_PREFIX}!"),
    [STRINGID_PKMNWASFROZEN]                        = COMPOUND_STRING("¡{B_EFF_NAME_WITH_PREFIX} se ha congelado!"),
    [STRINGID_PKMNFROZENBY]                         = COMPOUND_STRING("¡{B_BUFF1} de {B_SCR_NAME_WITH_PREFIX} congeló a {B_EFF_NAME_WITH_PREFIX}!"), //not in gen 5+, ability popup
    ...
    [STRINGID_PKMNWASPARALYZED]                     = COMPOUND_STRING("¡{B_EFF_NAME_WITH_PREFIX} está paralizado!\n¡Quizás no pueda moverse!"),
    [STRINGID_PKMNWASPARALYZEDBY]                   = COMPOUND_STRING("¡{B_BUFF1} de {B_SCR_NAME_WITH_PREFIX} paralizó a {B_EFF_NAME_WITH_PREFIX}! ¡Quizás no se mueva!"), //not in gen 5+, ability popup
    [STRINGID_PKMNISPARALYZED]                      = COMPOUND_STRING("¡{B_ATK_NAME_WITH_PREFIX} está paralizado!\n¡No puede moverse!"),
    ...
    [STRINGID_PKMNIMMOBILIZEDBYLOVE]                = COMPOUND_STRING("¡{B_ATK_NAME_WITH_PREFIX} no se mueve por amor!"),
    ...
    [STRINGID_PKMNREGAINEDHEALTH]                   = COMPOUND_STRING("¡{B_DEF_NAME_WITH_PREFIX} recuperó PS!"),
    [STRINGID_PKMNHPFULL]                           = COMPOUND_STRING("¡{B_DEF_NAME_WITH_PREFIX} tiene todos sus PS!"),
    ...
    [STRINGID_PKMNWHIPPEDWHIRLWIND]                 = COMPOUND_STRING("¡{B_ATK_NAME_WITH_PREFIX} levantó un torbellino!"),
    ...
    [STRINGID_PKMNHURTBY]                           = COMPOUND_STRING("¡{B_BUFF1} dañó a {B_ATK_NAME_WITH_PREFIX}!"),
    ...
    [STRINGID_PKMNHITWITHRECOIL]                    = COMPOUND_STRING("¡{B_ATK_NAME_WITH_PREFIX} sufrió daño por retroceso!"),
    [STRINGID_PKMNPROTECTEDITSELF2]                 = COMPOUND_STRING("¡{B_ATK_NAME_WITH_PREFIX} se está protegiendo!"),
    [STRINGID_PKMNBUFFETEDBYSANDSTORM]              = COMPOUND_STRING("¡La tormenta de arena zarandeó a {B_ATK_NAME_WITH_PREFIX}!"),
    [STRINGID_PKMNPELTEDBYHAIL]                     = COMPOUND_STRING("¡El granizo golpeó a {B_ATK_NAME_WITH_PREFIX}!"),
    ...
    [STRINGID_PKMNSAPPEDBYLEECHSEED]                = COMPOUND_STRING("¡DRENADORAS absorbió energía de {B_ATK_NAME_WITH_PREFIX}!"),
    ...
    [STRINGID_PKMNSTAYEDAWAKEUSING]                 = COMPOUND_STRING("¡{B_DEF_NAME_WITH_PREFIX} se mantuvo despierto con {B_DEF_ABILITY}!"), //not in gen 5+, ability popup
    ...
    [STRINGID_PKMNHURTBYSPIKES]                     = COMPOUND_STRING("¡Las púas dañaron a {B_SCR_NAME_WITH_PREFIX}!"),
    ...
    [STRINGID_PKMNGOTFREE]                          = COMPOUND_STRING("¡{B_ATK_NAME_WITH_PREFIX} se libró de {B_BUFF1} de {B_DEF_NAME_WITH_PREFIX}!"), //not in gen 5+, generic rapid spin?
    [STRINGID_PKMNSHEDLEECHSEED]                    = COMPOUND_STRING("¡{B_ATK_NAME_WITH_PREFIX} eliminó DRENADORAS!"), //not in gen 5+, generic rapid spin?
    [STRINGID_PKMNBLEWAWAYSPIKES]                   = COMPOUND_STRING("¡{B_ATK_NAME_WITH_PREFIX} dispersó las Púas!"), //not in gen 5+, generic rapid spin?
    ...
    [STRINGID_PKMNMADEITRAIN]                       = COMPOUND_STRING("¡{B_SCR_ABILITY} de {B_SCR_NAME_WITH_PREFIX} provocó la lluvia!"), //not in gen 5+, ability popup
    ...
    [STRINGID_PKMNPREVENTSUSAGE]                    = COMPOUND_STRING("¡{B_DEF_NAME_WITH_PREFIX}, con {B_DEF_ABILITY}, impide que {B_ATK_NAME_WITH_PREFIX} use {B_CURRENT_MOVE}!"), //I don't see this in SV text
    [STRINGID_PKMNRESTOREDHPUSING]                  = COMPOUND_STRING("¡{B_DEF_NAME_WITH_PREFIX} restauró PS usando su {B_DEF_ABILITY}!"), //not in gen 5+, ability popup
    [STRINGID_PKMNCHANGEDTYPEWITH]                  = COMPOUND_STRING("¡{B_DEF_ABILITY} de {B_DEF_NAME_WITH_PREFIX} lo convirtió en el tipo {B_BUFF1}!"), //not in gen 5+, ability popup
    [STRINGID_PKMNPREVENTSROMANCEWITH]              = COMPOUND_STRING("¡{B_DEF_ABILITY} de {B_DEF_NAME_WITH_PREFIX} impide el enamoramiento!"), //not in gen 5+, ability popup
    [STRINGID_PKMNPREVENTSCONFUSIONWITH]            = COMPOUND_STRING("¡{B_SCR_ABILITY} de {B_SCR_NAME_WITH_PREFIX} impide la confusión!"), //not in gen 5+, ability popup
    [STRINGID_PKMNRAISEDFIREPOWERWITH]              = COMPOUND_STRING("¡{B_DEF_ABILITY} de {B_DEF_NAME_WITH_PREFIX} reforzó sus ataques de Fuego!"), //not in gen 5+, ability popup
    [STRINGID_PKMNANCHORSITSELFWITH]                = COMPOUND_STRING("¡{B_DEF_NAME_WITH_PREFIX} se aferra al suelo con {B_DEF_ABILITY}!"), //not in gen 5+, ability popup
    [STRINGID_PKMNCUTSATTACKWITH]                   = COMPOUND_STRING("¡{B_SCR_ABILITY} de {B_SCR_NAME_WITH_PREFIX} bajó el Ataque de {B_DEF_NAME_WITH_PREFIX}!"), //not in gen 5+, ability popup
    [STRINGID_PKMNPREVENTSSTATLOSSWITH]             = COMPOUND_STRING("¡{B_SCR_ABILITY} de {B_SCR_NAME_WITH_PREFIX} impidió perder características!"), //not in gen 5+, ability popup
    [STRINGID_PKMNHURTSWITH]                        = COMPOUND_STRING("¡{B_BUFF1} de {B_DEF_NAME_WITH_PREFIX} dañó a {B_ATK_NAME_WITH_PREFIX}!"),
    [STRINGID_PKMNTRACED]                           = COMPOUND_STRING("It traced {B_BUFF1}'s {B_BUFF2}!"),
    [STRINGID_STATSHARPLY]                          = gText_StatSharply,
    [STRINGID_STATHARSHLY]                          = COMPOUND_STRING("bastante "),
    [STRINGID_ATTACKERSSTATROSE]                    = COMPOUND_STRING("¡{B_BUFF1} de {B_ATK_NAME_WITH_PREFIX} {B_BUFF2}subió!"),
    [STRINGID_DEFENDERSSTATROSE]                    = gText_DefendersStatRose,
    [STRINGID_SCRIPTINGSTATROSE]                    = COMPOUND_STRING("¡{B_BUFF1} de {B_SCR_NAME_WITH_PREFIX} {B_BUFF2}subió!"),
    ...
    [STRINGID_ONEHITKO]                             = COMPOUND_STRING("¡KO en un golpe!"),
    ...
    [STRINGID_DOWNPOURSTARTED]                      = COMPOUND_STRING("¡Comenzó a caer un chaparrón!"), // corresponds to DownpourText in pokegold and pokecrystal and is used by Rain Dance in GSC
    ...
    [STRINGID_SUNLIGHTSTRONG]                       = COMPOUND_STRING("Hace mucho sol…"), //not in gen 5+
    ...
    [STRINGID_WALLYUSEDITEM]                        = COMPOUND_STRING("¡BLAS usó {B_LAST_ITEM}!"),
    [STRINGID_TRAINERBLOCKEDBALL]                   = COMPOUND_STRING("¡El entrenador bloqueó tu Poké Ball!"),
    [STRINGID_DONTBEATHIEF]                         = COMPOUND_STRING("¡No robes!"),
    [STRINGID_ITDODGEDBALL]                         = COMPOUND_STRING("¡Esquivó tu Poké Ball! ¡No se puede capturar!"),
    [STRINGID_PKMNBROKEFREE]                        = COMPOUND_STRING("¡Vaya! ¡El POKéMON se ha escapado!"),
    [STRINGID_ITAPPEAREDCAUGHT]                     = COMPOUND_STRING("¡Huy! ¡Parecía que se había atrapado!"),
    [STRINGID_AARGHALMOSTHADIT]                     = COMPOUND_STRING("¡Casi lo consigues!"),
    [STRINGID_SHOOTSOCLOSE]                         = COMPOUND_STRING("¡Por muy poco!"),
#if IS_HNS
    [STRINGID_GOTCHAPKMNCAUGHTPLAYER]               = COMPOUND_STRING("¡Ya está! ¡{B_DEF_NAME} atrapado!{WAIT_SE}{PLAY_BGM 659}\p"),
    [STRINGID_GOTCHAPKMNCAUGHTWALLY]                = COMPOUND_STRING("¡Ya está! ¡{B_DEF_NAME} atrapado!{WAIT_SE}{PLAY_BGM 659}{PAUSE 127}"),
#else
    ...
    [STRINGID_ENEMYABOUTTOSWITCHPKMN]               = COMPOUND_STRING("¡{B_TRAINER1_NAME_WITH_CLASS} va a enviar a\n{B_BUFF2}!\p¿Quieres cambiar de POKéMON?"),
    ...
    [STRINGID_PKMNWATCHINGCAREFULLY]                = COMPOUND_STRING("¡{B_OPPONENT_MON1_NAME} te observa atentamente!"), //safari
    [STRINGID_PKMNCURIOUSABOUTX]                    = COMPOUND_STRING("¡{B_OPPONENT_MON1_NAME} siente curiosidad por el {B_BUFF1}!"), //safari
    [STRINGID_PKMNENTHRALLEDBYX]                    = COMPOUND_STRING("¡{B_OPPONENT_MON1_NAME} está embelesado con el {B_BUFF1}!"), //safari
    [STRINGID_PKMNIGNOREDX]                         = COMPOUND_STRING("¡{B_OPPONENT_MON1_NAME} ignoró completamente el {B_BUFF1}!"), //safari
    [STRINGID_THREWPOKEBLOCKATPKMN]                 = COMPOUND_STRING("¡{B_PLAYER_NAME} lanzó un {POKEBLOCK} a {B_OPPONENT_MON1_NAME}!"), //safari
    [STRINGID_OUTOFSAFARIBALLS]                     = COMPOUND_STRING("{PLAY_SE SE_DING_DONG}Encargado: ¡No te quedan más Safari Balls! ¡Se acabó el tiempo!\p"), //safari
    ...
    [STRINGID_PKMNSXRESTOREDHPALITTLE2]             = COMPOUND_STRING("¡{B_ATK_NAME_WITH_PREFIX} restauró algo sus PS con {B_ATK_ABILITY}!"), //not in gen 5+, ability popup
    ...
    [STRINGID_PKMNSXPREVENTSYLOSS]                  = COMPOUND_STRING("¡{B_SCR_ABILITY} de {B_SCR_NAME_WITH_PREFIX} impide perder {B_BUFF1}!"), //not in gen 5+, ability popup
    [STRINGID_PKMNSXINFATUATEDY]                    = COMPOUND_STRING("¡{B_DEF_ABILITY} de {B_DEF_NAME_WITH_PREFIX} enamoró a {B_ATK_NAME_WITH_PREFIX}!"), //not in gen 5+, ability popup
    [STRINGID_PKMNSXMADEYINEFFECTIVE]               = COMPOUND_STRING("¡{B_DEF_ABILITY} de {B_DEF_NAME_WITH_PREFIX} anuló {B_CURRENT_MOVE}!"), //not in gen 5+, ability popup
    ...
    [STRINGID_ITEMSCANTBEUSEDNOW]                   = COMPOUND_STRING("Aquí no se pueden usar objetos.{PAUSE 64}"), //not in gen 5+, i think
    [STRINGID_USINGITEMSTATOFPKMNROSE]              = COMPOUND_STRING("Usando {B_LAST_ITEM}, el {B_BUFF1} de {B_SCR_NAME_WITH_PREFIX} {B_BUFF2}."), //todo: update this, will require code changes
    [STRINGID_USINGITEMSTATOFPKMNFELL]              = COMPOUND_STRING("¡Al usar {B_LAST_ITEM}, {B_BUFF1} de {B_SCR_NAME_WITH_PREFIX} {B_BUFF2}bajó!"),
    ...
    [STRINGID_PKMNSXINTENSIFIEDSUN]                 = COMPOUND_STRING("¡{B_SCR_ABILITY} de {B_SCR_NAME_WITH_PREFIX} intensificó los rayos solares!"), //not in gen 5+, ability popup
    [STRINGID_YOUTHROWABALLNOWRIGHT]                = COMPOUND_STRING("Ahora debo lanzar una Ball, ¿no? ¡Intentaré hacerlo lo mejor posible!"),
    [STRINGID_PKMNSXTOOKATTACK]                     = COMPOUND_STRING("¡{B_DEF_ABILITY} de {B_DEF_NAME_WITH_PREFIX} recibió el ataque!"), //In gen 5+ but without naming the ability
    ...
    [STRINGID_USENEXTPKMN]                          = COMPOUND_STRING("¿Usar otro Pokémon?"),
    [STRINGID_PKMNFLEDUSINGITS]                     = COMPOUND_STRING("{PLAY_SE SE_FLEE}¡{B_ATK_NAME_WITH_PREFIX} escapó usando su {B_LAST_ITEM}!\p"),
    [STRINGID_PKMNFLEDUSING]                        = COMPOUND_STRING("{PLAY_SE SE_FLEE}¡{B_ATK_NAME_WITH_PREFIX} escapó usando su {B_ATK_ABILITY}!\p"), //not in gen 5+
    ...
    [STRINGID_BOXISFULL]                            = COMPOUND_STRING("¡Las CAJAS están llenas! ¡No puedes capturar más!\p"),
    ...
    [STRINGID_PKMNSXPREVENTSFLINCHING]              = COMPOUND_STRING("¡{B_EFF_ABILITY} de {B_EFF_NAME_WITH_PREFIX} impide el retroceso!"), //not in gen 5+, ability popup
    ...
    [STRINGID_THEWALLSHATTERED]                     = COMPOUND_STRING("¡Destruyó la protección!"), //not in gen5+, uses "your teams light screen wore off!" etc instead
    ...
    [STRINGID_HURTBYITEM]                           = COMPOUND_STRING("¡{B_LAST_ITEM} dañó a {B_ATK_NAME_WITH_PREFIX}!"),
    ...
    [STRINGID_POISONHEALHPUP]                       = COMPOUND_STRING("¡El veneno ha restaurado unos pocos PS a {B_ATK_NAME_WITH_PREFIX}!"), //don't think this message is displayed anymore
    ...
    [STRINGID_SOLARPOWERHPDROP]                     = COMPOUND_STRING("¡{B_ATK_ABILITY} de {B_ATK_NAME_WITH_PREFIX} hace que pierda unos pocos PS!"), //don't think this message is displayed anymore
    [STRINGID_AFTERMATHDMG]                         = COMPOUND_STRING("¡{B_ATK_NAME_WITH_PREFIX} sufrió daño!"),
    ...
    [STRINGID_ICEBODYHPGAIN]                        = COMPOUND_STRING("¡{B_ATK_ABILITY} de {B_ATK_NAME_WITH_PREFIX} hizo que recuperara unos pocos PS!"), //don't think this message is displayed anymore
    ...
    [STRINGID_CURSEDBODYDISABLED]                   = COMPOUND_STRING("¡{B_DEF_NAME_WITH_PREFIX} desactivó {B_BUFF1} de {B_ATK_NAME_WITH_PREFIX} con {B_DEF_ABILITY}!"),
    ...
    [STRINGID_MEGAEVOREACTING]                      = COMPOUND_STRING("¡{B_LAST_ITEM} de {B_ATK_NAME_WITH_PREFIX} reacciona ante el Mega Aro de {B_ATK_TRAINER_NAME}!"), //actually displays the type of mega ring in inventory, but we didnt implement them :(
    ...
    [STRINGID_PKMNSWILLPERISHIN3TURNS]              = COMPOUND_STRING("¡Ambos Pokémon se debilitarán dentro de tres turnos!"),  //don't think this message is displayed anymore
    ...
    [STRINGID_HEAVYRAIN]                            = COMPOUND_STRING("¡Ha empezado a llover con fuerza!"),
    ...
    [STRINGID_PKMNREVERTEDTOPRIMAL]                 = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX}'s Reversión Primigenia. ¡Ha vuelto a su forma primigenia!"),
    ...
    [STRINGID_PKMNSABILITYPREVENTSABILITY]          = COMPOUND_STRING("¡La {B_SCR_ABILITY} de {B_SCR_NAME_WITH_PREFIX} impide que la {B_DEF_ABILITY} de {B_DEF_NAME_WITH_PREFIX2} funcione!"), //not in gen 5+, ability popup
    ...
    [STRINGID_PKMNHURTBYFROSTBITE]                  = COMPOUND_STRING("¡La congelación dañó a {B_ATK_NAME_WITH_PREFIX}!"),
    ...
    [STRINGID_TEAMGAINEDEXP]                        = COMPOUND_STRING("¡El resto de tu equipo ganó puntos de\nEXP. gracias al REPARTIR EXP.!\p"),
    ...
    [STRINGID_TARGETISHURTBYSALTCURE]               = COMPOUND_STRING("¡{B_BUFF1} dañó a {B_ATK_NAME_WITH_PREFIX}!"),
    ...
    [STRINGID_FOGCREPTUP]                           = COMPOUND_STRING("¡Una niebla muy densa cubre el campo!"),
    ...
    [STRINGID_SUPEREFFECTIVETWOFOES]                = COMPOUND_STRING("¡Es muy eficaz en {B_DEF_NAME_WITH_PREFIX2} y {B_DEF_PARTNER_NAME}!"),
    [STRINGID_NOTVERYEFFECTIVETWOFOES]              = COMPOUND_STRING("No es muy eficaz en {B_DEF_NAME_WITH_PREFIX2} y {B_DEF_PARTNER_NAME}!"),
    ...
    [STRINGID_SILPHSCOPEUNVEILED]                   = COMPOUND_STRING("¡El SCOPE SILPH reveló la\nidentidad del FANTASMA!"),
    ...
    [STRINGID_THREWROCK]                            = COMPOUND_STRING("¡{B_PLAYER_NAME} lanzó una ROCA\na {B_OPPONENT_MON1_NAME}!"),
    [STRINGID_THREWBAIT]                            = COMPOUND_STRING("¡{B_PLAYER_NAME} lanzó CEBO\na {B_OPPONENT_MON1_NAME}!"),
    ...
    [STRINGID_PKMNDISGUISEWASBUSTED]                = COMPOUND_STRING("¡El disfraz de {B_SCR_NAME_WITH_PREFIX} se rompió!"),
...
const u8 gText_PkmnIsEvolving[] = _("¿Eh? ¡{STR_VAR_1}\nestá evolucionando!");
...
static const u8 sText_InGamePartnerSentOutNGoZ[] = _("¡{B_PARTNER_NAME_WITH_CLASS} envió a {B_PLAYER_MON1_NAME}! ¡Adelante, {B_PLAYER_MON2_NAME}!");
static const u8 sText_InGamePartnerSentOutPkmn1[] = _("¡{B_PARTNER_NAME_WITH_CLASS} envió a {B_PLAYER_MON1_NAME}!");
static const u8 sText_InGamePartnerSentOutPkmn2[] = _("¡{B_PARTNER_NAME_WITH_CLASS} envió a {B_PLAYER_MON2_NAME}!");
