...
static const u8 *const sHelpBarTexts[HELPBAR_COUNT] =
{
...
#if IS_HNS
    [HELPBAR_MAP_ZOOMED_OUT]        = COMPOUND_STRING("{B_BUTTON}SALIR"),
    [HELPBAR_MAP_ZOOMED_IN]         = COMPOUND_STRING("{B_BUTTON}SALIR"),
    [HELPBAR_MAP_ZOOMED_OUT_CANFLY] = COMPOUND_STRING("{B_BUTTON}SALIR {R_BUTTON}VOLAR"),
    [HELPBAR_MAP_ZOOMED_IN_CANFLY]  = COMPOUND_STRING("{B_BUTTON}SALIR {R_BUTTON}VOLAR"),
#else
    ...
    [HELPBAR_MAP_ZOOMED_OUT_CANFLY] = COMPOUND_STRING("{A_BUTTON}ZOOM {B_BUTTON}SALIR {R_BUTTON}VOLAR"),
    [HELPBAR_MAP_ZOOMED_IN_CANFLY]  = COMPOUND_STRING("{A_BUTTON}FULL {B_BUTTON}SALIR {R_BUTTON}VOLAR"),
#endif
    ...
    [HELPBAR_RIBBONS_LIST]          = COMPOUND_STRING("{A_BUTTON}VER {B_BUTTON}SALIR"),
